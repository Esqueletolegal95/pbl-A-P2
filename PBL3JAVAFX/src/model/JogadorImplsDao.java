...
public class JogadorImplsDao extends PessoaImplDao implements JogadorDao {
	protected int idJog= 30000; //Valor será incrementado para gerar o id
	 //Lista com as posicoes que poderão ser escolhidas

	@Override
	public Jogador inserirJogador(Selecao selecao, String nome, int idade, double altura, boolean titular, String nacio, String posicao, int camisa) { //Insere o jogador no atributo de Selecao
