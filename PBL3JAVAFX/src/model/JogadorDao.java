...
public interface JogadorDao{
	abstract Jogador inserirJogador(Selecao selecao, String nome, int idade, double altura, boolean titular, String nacio, String pocisao,int camisa);
	...
	abstract List<Jogador> listarJogadores();
}
